        ...
        return(
            <View>
                <View style={{borderRadius:scaleHeight(10), overflow:"hidden",marginTop:scaleHeight(440), marginLeft:scaleWidth(50)}}>
                    ...
                    <Text style={{fontSize:scaleFont(34), fontWeight:"bold",color:"rgb(51, 102, 255)", marginLeft:scaleWidth(50), marginTop:scaleHeight(10)}}>DataCollect</Text>
                <Text style={{paddingTop:scaleHeight(20), fontSize:scaleFont(20), marginLeft:scaleWidth(-20)}}>Developed by Kitaraju Mgonja</Text>
            </View>
        )
    }
